 ...
 *
 * @see    Interaction#cooldownScope Interaction.cooldownScope
 */
public enum CooldownScope
{
	 ...
	 * </ul>
	 */
	CHANNEL("C:%d","errors.cooldown.channel"),
	 ...
	 * </ul>
	 */
	USER_CHANNEL("U:%d|C:%d", "errors.cooldown.channel"),
	 ...
	 */
	GUILD("G:%d", "errors.cooldown.guild"),
	 ...
	 * {@link java.lang.NullPointerException NullPointerException}s from being thrown while generating cooldown keys!
	 */
	USER_GUILD("U:%d|G:%d", "errors.cooldown.guild"),
	 ...
	 */
	SHARD("S:%d", "errors.cooldown.shard"),
	 ...
	 * from being thrown while generating cooldown keys!
	 */
	USER_SHARD("U:%d|S:%d", "errors.cooldown.shard"),
